...
class DetFrameProducer : public edm::stream::EDProducer<> {
   ...
   private:
      ...
      std::vector<e2e::Frame1D> vHBHE_energy_reshaped (nDetFrameH, e2e::Frame1D (nDetFrameW,0.));
      e2e::Frame1D vECAL_energy_;
      std::vector<e2e::Frame1D> (nDetFrameH, e2e::Frame1D (nDetFrameW,0.)); 
      e2e::Frame1D vECAL_tracksPt_;
      std::vector<e2e::Frame1D> vECAL_tracksPt_reshaped (nDetFrameH, e2e::Frame1D (nDetFrameW,0.));
      e2e::Frame1D vECALadj_tracksPt_[Nadjproj];
      std::vector<e2e::Frame1D> vECALad_tracksPt_reshaped (nDetFrameH, e2e::Frame1D (nDetFrameW,0.));
