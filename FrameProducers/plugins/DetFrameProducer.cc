...
DetFrameProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   if (doHBHEenergy){
   	e2e::fillHBHE (iEvent, iSetup, HBHERecHitCollectionT_, vHBHE_energy_, vHBHE_energy_EB_ );
   ...
   if (doTracksAtECALadjPt){
   	...
   	{
     		e2e::fillTracksAtECALadjustable( iEvent, iSetup, i, EBRecHitCollectionT_, EERecHitCollectionT_, vECALadj_tracksPt_, vECALadj_tracks_, vECALadj_tracksPt_max_ );
