...
#include "E2eDL/FrameProducers/interface/TracksAtECALstitched.h"
...
void e2e::fillTracksAtECALadjustable ( const edm::Event& iEvent, const edm::EventSetup& iSetup, unsigned int proj, edm::EDGetTokenT<EcalRecHitCollection> EBRecHitCollectionT_, edm::EDGetTokenT<EcalRecHitCollection> EERecHitCollectionT_, e2e::Frame2D vECALadj_tracksPt_, e2e::Frame2D vECALadj_tracks_, e2e::Frame2D vECALadj_tracksPt_max_) {
