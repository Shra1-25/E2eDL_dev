...
std::vector<int> e2e::findSubcrystal(const CaloGeometry* caloGeom, const float& eta, const float& phi, const int& granularityMultiEta, const int& granularityMultiPhi)
{
...
void e2e::fillByBinNumber(TH2F * histo, const std::vector<int>& phi_eta, const float& value)
{
...
void e2e::fillTracksAtECALadjustable ( const edm::Event& iEvent, const edm::EventSetup& iSetup, unsigned int proj, edm::EDGetTokenT<EcalRecHitCollection> EBRecHitCollectionT_, edm::EDGetTokenT<EcalRecHitCollection> EERecHitCollectionT_,  edm::EDGetTokenT<reco::TrackCollection> trackCollectionT_, e2e::Frame1D& vECALadj_tracksPt_[Nadjproj], e2e::Frame1D& vECALadj_tracks_[Nadjproj], e2e::Frame1D& vECALadj_tracksPt_max_[Nadjproj]) {
